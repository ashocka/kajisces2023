...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar(
			array(
				'name'          => __( 'Financerji', 'understrap' ),
				'id'            => 'financerji',
				'description'   => __( 'Full sized footer widget for logos of financers with dynamic grid', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="financerji footer-widget %2$s dynamic-classes">',
				'after_widget'  => '</div><!-- .footer-widget -->',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
			)
